      ...
      ?>
        ...
        <br>
              <div class="date-range-report ">
                <a href="add_prooduct.php?category=<?php echo $product_category ?>" class="badge badge-primary" ">Ajouter 
      <?php
      if($product_category==0)
        echo "Une Boisson";
      else if($product_category==1)
...
if($product_category==-1)
  ...
  $result=mysqli_query($con,"select product_id,product_image, product_title,product_price from products where product_cat=$product_category")or die ("query 1 incorrect.....");
...
<div class='col-lg-6 col-xl-4' >
    <div class='card text-white bg-primary mb-3'>
        <div class='hovereffect'>
            ...
            <div class='overlay'>
                <h2>$product_name</h2>
                <a class='info' href='edit_product.php?id=".$product_id."'>Modifier</a>
                <a class='info' href='#' data-toggle='modal' data-target='#deletePopUp".$product_id."'>Supprimer</a>
            </div>
        </div>
    </div>
</div>
";
echo '<div class="modal fade" id="deletePopUp'.$product_id.'" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a type="button" class="btn btn-primary" href="products.php?product_id='.$product_id.'&action=delete">Supprimer</a>
      </div>
    </div>
  </div>
</div>';
