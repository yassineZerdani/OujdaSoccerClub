...
<!--
      ...
      <div class="content-wrapper">
        <div class="content">
        	<a href="ordersFinal.php" class="badge badge-success float-right">Commandes en attente</a>
        	<br>
        	<br>
          <!-- Recent Order Table -->
              ...
              <table class="table card-table table-responsive table-responsive-large table-striped" style="width:100%">
                ...
                <tbody>
                    <?php
                      ...
                      ?>
                           ...
                           ?>
                            ...
                            <?php }?></td>
                                ...
                                <td class='d-none d-md-table-cell'><?php echo $total_amount ?></td>
                                <td class='text-center'>
                                    <?php
                           	 			$query1 = "SELECT p_status FROM orders where order_id = $order_id";
                       					$run1 = mysqli_query($con,$query1); 
                     ...
                     echo "<center><h2>Pas de Commandes</h2><br><hr></center>";
                     }
                  ?>
                </tbody>
              </table>
