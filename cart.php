        ...
        <div class="container-table100">
          <div class="wrap-table100">
            <div class="table100">
                ...
                <tbody>
                  ...
                  foreach ($_SESSION["products"] as $product_id => $product) {
                    ...
                    echo "<tr id=$product_id>
                        ...
                        <td class=price><input type=\"number\"    min=\"1\" onchange=handleChange(this) value=\"$price\" /></td>
              ...
              <br>
              <div style="font-size:25px" class="row"><span>&nbsp;&nbsp;&nbsp;TOTAL:&nbsp;</span>
                <div id="Total" style='font-weight:bold'></div><span>&nbsp;DH</span>
              </div>
              <br>
...
<script>
  function total() {
    $('#Total').text(0);
    $('.total').each((k, e) => {
      e.textContent = parseInt(e.closest('tr').querySelector('.price input').value) * parseInt(e.closest('tr').querySelector('.quantity input').value);
  ...
  function handleDelete(e, id) {
    ...
    $.ajax({
      ...
      success: (response) => {
        n = parseInt(e.closest('tr').querySelector('.price input').value) * parseInt(e.closest('tr').querySelector('.quantity input').value);
        $(e).closest('tr').remove();
