...
if (isset($_POST['btn_save'])) {
  ...
  $picture_tmp_name = $_FILES['avatar']['tmp_name'];
  $picture_size = $_FILES['avatar']['size'];

  if ($picture_size <= 50000000) {
    //$pic_name = time() . "_" . $picture_name;
    //move_uploaded_file($picture_tmp_name, "assets/img/user/" . $pic_name);
    $response = \Cloudinary\Uploader::upload($picture_tmp_name,array(
    "folder" => "users/"))['public_id'];
    mysqli_query($con, "insert into users (full_name,num_teleph,type_abonnement,avatar,paiement,paiement_avance,paiement_status) values ('$full_name','$num_teleph','$type_abonnement','$response','$paiement','$paiement_avance','$paiement_status')")
          ...
          <div class="card card-default">
            <div class="card-body">
              <div class="container tm-mt-big tm-mb-big">
                <div class="row">
                  <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                      <div class="row">
                        <div class="col-12">
                          <h3 class="tm-block-title d-inline-block">Ajouter Un Utilisateur</h3>
                        </div>
                      </div>
                      <div class="row tm-edit-product-row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                          <form action="add_uuser.php" name="form" method="post" enctype="multipart/form-data" class="tm-edit-product-form">
                            <div class="form-group mb-3">
                              <label for="name">Nom D'utilisateur</label>
                              <input class="form-control validate" type="text" name="full_name" id="full_name" autofocus style="width:100%" required>
                            </div>
                            <div class="form-group mb-3">
                              <label for="description">Numero De Téléphone</label>
                              <input type="text" class="form-control validate" name="num_teleph" id="num_teleph" required>
                            </div>
                ...
                <br>
                            <label style="font-weight: 400;line-height: 1.5; color: #1b223c; font-size: 0.98rem; text-align: left;" 
                            for="description">Type D'abonnement</label>
                            <br>
...
<br>
                            ...
                            <div class="form-group mb-3">
                              ...
                              <input type="text" class="form-control validate" name="paiement" id="paiement" required>
                            </div>
                            <div class="form-group mb-3">
                              <label for="description">Avance De Paiement</label>
                              <input type="text" class="form-control validate" name="paiement_avance" id="paiement_avance" required>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                          ...
                          <div class="form-group mb-3">
                            ...
                            <div>
                              ...
                              <label for="termin&eacute">termin&eacute</label>
                            </div>
                        ...
                        <div class="col-12">
                          <button type="submit" name="btn_save" id="btn_save" class="btn btn-primary btn-block text-uppercase">Ajouter</button>
                        </div>
                        </form>
                      </div>
                    </div>
