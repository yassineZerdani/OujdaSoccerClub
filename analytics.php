...
<!--
  ...
  h1 { font-size: 70px; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; color: black}
...
<article >
<img id="im1" src="img/wah.png" style="width: 200px; height:200px;text-align: center;" >
    <h1>Page En Maintenance</h1>
    <div>
        <p>Desolé pour cette erreur. Cette page est en cours de traitement, vous pouvez nous contacter: <a href="mailto:#">contact us</a>, on reviendra plutard.</p>
        <p>&mdash; HexDebug</p>
    </div>
</article>
