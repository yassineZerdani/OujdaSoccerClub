      ...
      <div id="sidebar" class="sidebar sidebar-with-footer">
        ...
        <div class="sidebar-scrollbar">
          ...
          <ul class="nav sidebar-inner" id="sidebar-menu">
            ...
            <li class="has-sub">
              <a class="sidenav-item-link" href="terrains.php">
...
$result=mysqli_query($con,"select product_id,product_image, product_title,product_price from products where product_cat=4 Limit $page1,10")or die ("query 1 incorrect.....");
...
<div class='col-lg-6 col-xl-4' >
    <div class='card text-white bg-primary mb-3'>
        <div class='hovereffect'>
            <img class='img-responsive' src='product_images/$image' alt='' style='height: 16rem; display: block; object-fit: cover; margin-left: auto; margin-right: auto;'>
            <div class='overlay'>
                <h2>$product_name</h2>
