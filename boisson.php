...
<div class="content-wrapper">
        <div class="content">
        <h2 style="color: rgba(0,0,0,0.5);font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-size:xx-large;">Les Boissons</h2>
        <br>
              <div class="date-range-report ">
                <a href="add_prooduct.php" style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-size:large;">Ajouter un Boisson</a>
              </div>
...
$result=mysqli_query($con,"select product_id,product_image, product_title,product_price from products where product_cat=1")or die ("query 1 incorrect.....");
